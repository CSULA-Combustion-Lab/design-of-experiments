...
Equivalence                  = [0.25, 2, 12] # Used in mixture types with phi
fraction_in_oxidizer_or_fuel = [0.05, 0.95, 12]  # X / (X+diluent) where X is O2 or fuel. Used for Oxi_dil or Fue_dil
